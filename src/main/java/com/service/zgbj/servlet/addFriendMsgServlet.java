 ...
 */
@WebServlet("/friend/addFriendMsg")
public class addFriendMsgServlet extends HttpServlet {
    @Autowired
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().write(service.addFriendMsg(to_id, from_id,pid,friend_type, source, content));
    }
}
